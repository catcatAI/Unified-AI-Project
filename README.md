...
**Quick facts**: 612 Python files in backend src (~96K lines). Electron + Live2D desktop companion (50 JS files across shared-js/desktop/web). Pixel art engine (PyQt6 renderer). **~5,085 tests (full) / ~4,753 tests (tests/) — 0 errors.**  
...
| **Tests** | ✅ PASSING | ~5,085 tests collected (full) / ~4,753 (tests/), 0 errors, 0 collection errors |
...
| **測試** | ✅ 通過 | ~5,085 (全部) / ~4,753 (tests/) — 0 collection errors |
