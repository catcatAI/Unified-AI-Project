...
| **Composite** | **6.0/10** | — (no single native total) | Architecture ~95% complete. Native capability is multi-dimensional, not a single score: deterministic engines strong (math 9.5 / knowledge 10 / symbolic reasoning 10 / autonomy 9.0); **neural-net net contribution ≈35%** (DET-CARRY differential, see INTELLIGENCE_ASSESSMENT §1.1 & §4.1.1). Do not sum heterogeneous dimensions into one "actual" number. |
