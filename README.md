...
**Quick facts**: 612 Python files in backend src (~96K lines). Electron + Live2D desktop companion (50 JS files across shared-js/desktop/web). Pixel art engine (PyQt6 renderer). **~5,092 tests (full) / ~4,763 tests (tests/) — 0 errors.**  
...
| **Tests** | ✅ PASSING | ~5,092 tests collected (full) / ~4,763 (tests/), 0 errors, 0 collection errors |
