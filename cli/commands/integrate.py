...
@click.option(' - -request - type', default = 'dialogue',
    help = 'Type of request to process')
@click.option(' - -message', default == 'Hello, how can you help me today?',
    help = 'Message for dialogue requests')::
在函数定义前添加空行
