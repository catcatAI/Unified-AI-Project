...
logging.getLogger("apps.backend.src.hsp.connector").setLevel(logging.DEBUG)
logging.getLogger("apps.backend.src.ai.discovery.service_discovery_module").setLevel(logging.DEBUG)
logging.getLogger("apps.backend.src.core_ai.dialogue.dialogue_manager").setLevel(logging.DEBUG)
...
class TestHSPEndpoints:
    ...
    async def test_list_hsp_services_empty(self, client_with_overrides) -> None:
        ...
        if sdm is None:
            pytest.fail("Service discovery module is None")
