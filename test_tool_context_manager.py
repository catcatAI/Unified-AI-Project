...
from tool_context_manager import ToolCategory, Tool, ToolUsageRecord, ToolPerformanceMetrics
...
class TestToolContextManager(unittest.TestCase):
    ...
    def test_delete_category_with_tools(self):
        """测试删除包含工具的分类"""
        category_id = "test_category"
        tool_id = "test_tool"
    ...
    def test_get_top_performing_tools(self):
        """测试获取性能最好的工具"""
        # 注册多个工具并记录使用情况
    ...
    def test_move_tool_to_category(self):
        """测试移动工具到指定分类"""
        tool_id = "test_tool"
