...
class UnifiedAutoFix:
    ...
    # 启用修复类型
    _ = self.fix_engine.enable_fix_type(FixType.IMPORT_FIX)
    _ = self.fix_engine.enable_fix_type(FixType.DEPENDENCY_FIX)
    _ = self.fix_engine.enable_fix_type(FixType.SYNTAX_FIX)
    _ = self.fix_engine.enable_fix_type(FixType.CLEANUP_FIX)
