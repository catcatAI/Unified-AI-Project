...
# Red point
vec[5] = 0.3; vec[6] = 0.3; vec[7] = 1.0; vec[8] = 0.0; vec[9] = 0.0

# Green plane
off = 5 + 15*5 + 10*8
vec[off] = 0.5; vec[off+1] = 0.5; vec[off+2] = 0.3; vec[off+3] = 0.3
vec[off+4] = 0.0; vec[off+5] = 0.5; vec[off+6] = 0.0

# Red circle
off2 = off + 5*9
vec[off2] = 0.5; vec[off2+1] = 0.5; vec[off2+2] = 0.2
vec[off2+3] = 1.0; vec[off2+4] = 0.0; vec[off2+5] = 0.0
