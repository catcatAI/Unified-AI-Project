...
class CompleteSystemValidator:
    ...
    def validate_file_structure(self, file_path: Path, expected_structure: Dict[str, Any]) -> bool:
        """验证文件结构"""
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                content = f.read()
            ...
            for check_name, check_func in expected_structure.items():
                if callable(check_func):
                    ...
                    # 如果check_func不是可调用对象，则检查它是否在content中
                    results[check_name] = str(check_func) in content
    ...
    def run_comprehensive_validation(self) -> Dict[str, Any]:
        ...
        final_result = {
            ...
            "errors_found": self.errors_found.copy(),
            "warnings_found": self.warnings_found.copy(),
            "missing_files": self.missing_files.copy(),
            "syntax_errors": self.syntax_errors.copy(),
            "test_failures": self.test_failures.copy()
        }
