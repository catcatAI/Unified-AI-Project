...
**4,488 tests collected** (tests/; authoritative count per AGENTS.md, last verified after SNN memory-bound eviction + Save/Load fix: 10 new regression tests) route fix).
