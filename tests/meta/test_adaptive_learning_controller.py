...
class TestAdaptiveLearningController(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.controller._schedule_strategy_improvement = (
            AsyncMock()
        )  # Still mock this method for assert_called_once
    ...
    async def test_adapt_learning_strategy(self) -> None:
        ...
        self.controller.performance_tracker.analyze_trend.return_value = {
            "direction": "stable",
            "magnitude": 0.0,
        }
        ...
        self.controller.performance_tracker.analyze_trend.assert_called_once_with(
            performance_history
        )
        self.controller.strategy_selector.select.assert_called_once_with(
            task_context, {"direction": "stable", "magnitude": 0.0}
        )
