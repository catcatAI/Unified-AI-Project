...
class TestCodeUnderstandingTool(unittest.TestCase):
    ...
    def test_list_tools_success(self) -> None:
        ...
        mock_tool_files = [
            os.path.join(
                "dummy/tools", "math_tool.py"
            ),  # Note: self.tool.tools_directory is not used by mock
        ...
        mock_structure = {
            ...
            "functions": [
                ...
                },
                {
                    ...
                    "parameters": [{"name": "text", "annotation": "str", "default": None}],
                    "returns": "str | None",
                },
                {
                    "name": "calculate",
                    ...
                    "parameters": [{"name": "input_string", "annotation": "str", "default": None}],
    ...
    def test_describe_tool_not_found(self) -> None:
        ...
        self.mock_lwm_instance.get_tool_structure.return_value = (
            None  # LWM returns None if not found
        )
