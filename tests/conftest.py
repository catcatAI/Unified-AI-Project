...
def mock_core_services():
    ...
    mock_trust_manager = MagicMock(spec='src.ai.trust_manager.trust_manager_module.TrustManager')
    ...
    mock_formula_engine = MagicMock(spec='src.ai.formula_engine.FormulaEngine')
