...
class TestAngelaCore:
    ...
    def test_live2d_manager(self):
        ...
        required_functions = ["initialize()", "loadModel(", "setExpression(", "playMotion("]
    ...
    def test_performance_settings(self):
        ...
        performance_indicators = ["detect()", "optimizeForHardware", "frameRate", "resolution"]
    ...
    def test_installation_scripts(self):
        """測試安裝腳本"""
        install_files = ["install_angela.py", "setup_angela.sh"]
...
class TestAngelaPerformance:
    ...
    def test_performance_modes(self):
        ...
        if perf_js.exists():
            ...
            required_modes = ["very_low", "low", "medium", "high", "ultra"]
    ...
    def test_hardware_detection(self):
        ...
        if hardware_js.exists():
            ...
            detection_methods = ["_detectGPU", "_detectRAM", "_detectPlatform", "_detectDeviceType"]
