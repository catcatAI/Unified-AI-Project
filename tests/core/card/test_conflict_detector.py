...
class TestConflictDetector:
    ...
    def test_detect_between_different_core_traits(self):
        detector = ConflictDetector()
        a = Card(
            card_id="CC-01", qualified_id="CC-01@W01", world_line="W01", name="A", core_trait="勇敢"
        )
        b = Card(
            card_id="CC-01", qualified_id="CC-01@W02", world_line="W02", name="B", core_trait="謹慎"
        )
    ...
    def test_detect_between_same_trait_no_conflict(self):
        ...
        b = Card(
            card_id="CC-01", qualified_id="CC-01@W02", world_line="W02", name="B", core_trait="勇敢"
        )
        cross = detector.detect_between([a, b])
