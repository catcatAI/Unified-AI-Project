...
)  # Import the main engine for _calculate_real_correlation
...
class TestRealCausalEngineSimplified:
    ...
    async def test_causal_strength_calculation_simplified(self):
        ...
        causal_strength_weak = await engine._calculate_real_causal_strength(
    ...
    async def test_intervention_planner_simplified(self):
        ...
        # 设置当前状态
        current_state = {"temperature": 25, "marketing": 100, "sales": 150}
        ...
        # 进行干预规划
        intervention_plan = await planner.optimize(
    ...
    def test_error_handling_robustness(self):
        ...
        correlation_empty = engine._calculate_real_correlation(
            [], []
        ...
        correlation_mismatch = engine._calculate_real_correlation(
            mismatched_data1, mismatched_data2
        )
