...
class TestBrainBridgeService:
    ...
    def test_instantiation(self, mock_probe):
        ...
        instance = BrainBridgeService(
            digital_life=mock_digital_life, metrics_path="test_metrics.md"
        )
    ...
    def test_get_current_status(self, mock_probe):
        ...
        mock_digital_life.biological_integrator.get_biological_state.return_value = {
            "heart_rate": 72
        }
        mock_probe.return_value = MagicMock()
        mock_probe.return_value.detect.return_value = MagicMock(
            ...
            accelerator_type=MagicMock(value="cuda"),
        )
        instance = BrainBridgeService(
            digital_life=mock_digital_life, metrics_path="test_metrics.md"
        )
