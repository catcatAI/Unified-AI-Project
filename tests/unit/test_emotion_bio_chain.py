...
class TestEmotionToBiologyMapping:
    ...
    def test_no_overlap_between_maps(self):
        from api.routes.chat_routes import _EMOTION_TO_RELAXATION_MAP, _EMOTION_TO_STRESS_MAP
...
class TestInjectEmotionBehavioralContext:
    ...
    def mock_emotion_system(self):
        ...
        es.get_behavioral_adjustment = MagicMock(
            return_value={
    ...
    def patches(self, mock_emotion_system, mock_bio):
        with patch("api.routes.chat_routes._get_emotion_system", return_value=mock_emotion_system):
