...
class TestAIOpsEngine:
    ...
    async def test_detect_anomalies_high_cpu(self, ai_ops_engine):
        """測試高CPU異常檢測"""
        metrics = {"cpu_usage": 95.0, "memory_usage": 75.0, "error_rate": 2.5, "response_time": 450}
    ...
    async def test_detect_anomalies_high_memory(self, ai_ops_engine):
        """測試高內存異常檢測"""
        metrics = {"cpu_usage": 70.0, "memory_usage": 90.0, "error_rate": 2.5, "response_time": 450}
    ...
    async def test_detect_anomalies_high_error_rate(self, ai_ops_engine):
        """測試高錯誤率異常檢測"""
        metrics = {"cpu_usage": 70.0, "memory_usage": 75.0, "error_rate": 6.0, "response_time": 450}
    ...
    async def test_detect_anomalies_no_issues(self, ai_ops_engine):
        """測試無異常情況"""
        metrics = {"cpu_usage": 50.0, "memory_usage": 60.0, "error_rate": 1.0, "response_time": 200}
...
class TestPredictiveMaintenance:
    ...
    def test_simple_health_assessment_good(self, predictive_maintenance_engine):
        """測試健康評估良好"""
        metrics = {"cpu_usage": 50.0, "memory_usage": 60.0, "response_time": 200, "error_rate": 1.0}
    ...
    def test_simple_health_assessment_poor(self, predictive_maintenance_engine):
        """測試健康評估差"""
        metrics = {"cpu_usage": 90.0, "memory_usage": 85.0, "response_time": 800, "error_rate": 5.0}
    ...
    def test_predict_failure_probability(self, predictive_maintenance_engine):
        """測試故障預測"""
        metrics = {"cpu_usage": 85.0, "memory_usage": 80.0, "response_time": 600, "error_rate": 3.0}
    ...
    async def test_predict_cpu_needs_with_data(self, capacity_planner):
        ...
        for i in range(20):
            ...
            capacity_planner.usage_history.append(
                {"timestamp": usage.timestamp.isoformat(), "usage": usage}
            )
...
class TestIntelligentOpsManager:
    ...
    async def test_get_ops_dashboard_data(self, intelligent_ops_manager):
        """測試獲取運維儀表板數據"""
        # 模擬系統健康分析
        intelligent_ops_manager._analyze_system_health = AsyncMock(
            return_value={"overall_score": 85.0, "unhealthy_components": []}
        )
...
class TestIntegration:
    ...
    async def test_components_interaction(
        self, ai_ops_engine, predictive_maintenance_engine, performance_optimizer, capacity_planner
    ):
        """測試組件交互"""
        # 創建所有組件
        ...
        for i in range(20):
            ...
            planner.usage_history.append(
                {"timestamp": historical_usage.timestamp.isoformat(), "usage": historical_usage}
            )
