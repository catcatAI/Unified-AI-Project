    ...
    def test_no_eval_usage(self) -> None:
        ...
        with open(
            ...
            direct_eval_calls = [
                ...
                or (line.strip().startswith("return eval("))
                or ("= eval(" in line and "def" not in line)
            ]
            self.assertEqual(
                len(direct_eval_calls),
                0,
                f"Found direct eval() calls in data_generator.py: {direct_eval_calls}",
            )
        ...
        with open(
            ...
            self.assertEqual(
                len(direct_eval_calls),
                0,
                f"Found direct eval() calls in lightweight_math_model.py: {direct_eval_calls}",
            )
        ...
        with open(
            ...
            self.assertEqual(
                len(direct_eval_calls),
                0,
                f"Found direct eval() calls in logic_data_generator.py: {direct_eval_calls}",
            )
        ...
        with open(
            ...
            self.assertEqual(
                len(direct_eval_calls),
                0,
                f"Found direct eval() calls in lightweight_logic_model.py: {direct_eval_calls}",
            )
