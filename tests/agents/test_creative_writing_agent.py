...
async def test_creative_agent_handle_task_request_generate_marketing_copy(creative_agent) -> None:
    ...
    envelope = HSPMessageEnvelope(
        ...
        recipient_ai_id=creative_agent.agent_id,
    ...
    # Call the handler
    await creative_agent.handle_task_request(task_payload, "sender_456", envelope)
...
async def test_creative_agent_handle_task_request_polish_text(creative_agent) -> None:
    ...
    task_payload = HSPTaskRequestPayload(
        ...
        parameters={"text_to_polish": "This is a sample text that needs polishing."},
        callback_address="test/callback/topic",
    )
    ...
    # Call the handler
    await creative_agent.handle_task_request(task_payload, "sender_789", envelope)
...
async def test_creative_agent_handle_task_request_unsupported_capability(creative_agent) -> None:
    ...
    # Call the handler
    await creative_agent.handle_task_request(task_payload, "sender_202", envelope)
...
async def test_creative_agent_polish_text(creative_agent) -> None:
    ...
    params = {"text_to_polish": "This is a sample text that needs polishing."}
