...
from ai.reasoning.real_causal_reasoning_engine import (
    RealCausalReasoningEngine,
    RealCausalGraph,
    RealInterventionPlanner,
...
class TestRealCausalReasoningEngine:
    ...
    def original_engine_config(self):
        """原始引擎配置"""
        return {"causality_threshold": 0.5}
    ...
    async def test_temporal_pattern_detection(self, real_engine):
        ...
        observation = {
            ...
            "data": {"temperature": increasing_data},
        }
    ...
    async def test_causal_strength_calculation(self, real_engine):
        ...
        causal_strength = await real_engine._calculate_real_causal_strength(
            "temperature", "sales", data
        )
    ...
    async def test_counterfactual_reasoning(self, real_engine):
        ...
        observations = [
            {
                ...
                "data": {"temperature": [20, 22, 25, 28, 30], "sales": [100, 110, 125, 140, 150]},
            },
            {
                "id": "obs2",
                "variables": ["temperature", "sales"],
                "data": {"temperature": [18, 20, 23, 26, 29], "sales": [95, 105, 120, 135, 145]},
            },
        ]
        ...
        intervention = {"variable": "temperature", "value": 35}  # 提高温度

        counterfactual_result = await real_engine.perform_counterfactual_reasoning(
    ...
    async def test_intervention_planning(self, real_engine):
        ...
        # 设置当前状态
        current_state = {"temperature": 25, "price": 100, "marketing_spend": 50}

        # 期望结果
        desired_outcome = {"variable": "sales", "target_value": 200}
    ...
    async def test_error_handling_and_robustness(self, real_engine):
        ...
        # 测试空数据
        empty_observation = {"id": "empty_test", "variables": [], "data": {}}
        ...
        invalid_observation = {
            "id": "invalid_test",
            "variables": ["var1", "var2"],
            "data": {"var1": [1, 2, 3], "var2": [4, 5]},  # 长度不匹配
        }
        ...
        # 测试模型不可用情况
        config_no_ai = {"enable_ai_models": False, "causality_threshold": 0.5}
