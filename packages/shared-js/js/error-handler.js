...
class ErrorHandler {
  ...
  static safeExecute(fn, options = {}) {
    const { context = 'Unknown', onError = null, defaultValue = null, logErrors = true } = options
  ...
  static withErrorHandling(options = {}) {
    return function (target, propertyKey, descriptor) {
      ...
      descriptor.value = function (...args) {
        ...
        return ErrorHandler.safeExecute(() => originalMethod.apply(this, args), {
          ...options,
          context,
        })
      }
  ...
  static async retry(fn, options = {}) {
    const { maxRetries = 3, delay = 1000, context = 'Retry', onError = null } = options
