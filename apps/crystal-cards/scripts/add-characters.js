...
const locationMap = {
  'CC-03': 'loc_mirror_lake',
  'CC-04': 'loc_witch_academy',
  'CC-05': 'loc_corridor',
  'CC-06': 'loc_market',
  'CC-07': 'loc_library',
  'CC-08': 'loc_convenience_store',
  'CC-09': 'loc_witch_academy',
  'CC-10': 'loc_holy_cross',
  'CC-11': 'loc_witch_academy',
  'CC-12': 'loc_agriculture',
  'CC-13': 'loc_holy_cross',
  'CC-14': 'loc_forest',
  'CC-15': 'loc_mirror_lake',
  'CC-16': 'loc_holy_cross',
  'CC-18': 'loc_mirror_lake',
  'CC-19': 'loc_holy_cross',
  'CC-20': 'loc_mirror_lake',
  'CC-21': 'loc_library',
  'CC-22': 'loc_library',
  'CC-23': 'loc_library',
  'CC-24': 'loc_corridor',
  'CC-25': 'loc_witch_academy',
  'CC-26': 'loc_market',
  'CC-27': 'loc_convenience_store',
  'CC-28': 'loc_holy_cross',
  'CC-29': 'loc_witch_academy',
  'CC-30': 'loc_holy_cross',
  'CC-31': 'loc_corridor',
  'CC-33': 'loc_witch_academy',
  'CC-34': 'loc_witch_academy',
  'CC-35': 'loc_library',
  'CC-36': 'loc_library',
  'CC-40': 'loc_library',
  'CC-41': 'loc_library',
  'CC-42': 'loc_fog_islands',
  'CC-43': 'loc_rust_city',
  'CC-44': 'loc_rust_city',
  'CC-45': 'loc_market',
  'CC-46': 'loc_witch_academy',
  'CC-47': 'loc_corridor',
  'CC-48': 'loc_library',
  'CC-54': 'loc_frozen_wastes',
  'CC-56': 'loc_orbital_station',
  'CC-60': 'loc_market',
  'CC-63': 'loc_abandoned_mine',
  'CC-64': 'loc_abandoned_mine',
  'CC-65': 'loc_abandoned_mine',
  'CC-66': 'loc_mirror_lake',
  'CC-67': 'loc_mirror_lake',
  'CC-68': 'loc_corridor',
  'CC-69': 'loc_corridor',
  'CC-70': 'loc_market',
  'CC-71': 'loc_market',
...
const missing = allCards.filter(
  (c) => c.card_id && /^CC-\d+$/.test(c.card_id) && !inGameIds.has(c.card_id)
)
...
missing.forEach((card) => {
  ...
  dlgEntries.push(
    `    ${dlgId}: { speaker: '${esc(rawName)}', text: '${esc(desc).slice(0, 60)}', choices: [{ text: '你是誰？', next: '${id}_who' }, { text: '離開', next: null }] },`
  )
  dlgEntries.push(
    `    ${id}_who: { speaker: '${esc(rawName)}', text: '「我叫${esc(rawName)}。${esc(race).slice(0, 30)}。」', choices: [{ text: '知道了', next: null }] },`
  )
})
