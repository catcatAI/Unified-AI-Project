...
class AngelaDNA:
    ...
    def _build_volumetric_body(self):
        # 1. 核心軀幹 (Z=2) - ID: 101
        self._build_part(2, (150, 300), (44, 84), [0.98, 0.98, 1.0], 0.5, 101)
        # 2. 左手與右手 (Z=4) - ID: 201, 202
        self._build_part(4, (140, 240), (28, 48), [0.95, 0.95, 1.0], 0.4, 201) # Left
        self._build_part(4, (140, 240), (80, 100), [0.95, 0.95, 1.0], 0.4, 202) # Right
        # 3. 分離的雙腿 (Z=2) - ID: 103, 104 (關鍵細節：中間留出空隙)
        self._build_part(2, (300, 380), (42, 62), [0.98, 0.98, 1.0], 0.6, 103) # Left Thigh
        self._build_part(2, (300, 380), (66, 86), [0.98, 0.98, 1.0], 0.6, 104) # Right Thigh
