...
class TestContentAnalyzerModule(unittest.TestCase):
    ...
    def assertEntityInGraph(self, expected_label: str, expected_type: str, kg_data: dict, msg: str = ""):
        """
    ...
    def assertRelationshipInGraph(self, kg_data: dict, nx_graph: nx.DiGraph,
                                  expected_src_label: str, expected_tgt_label: str,
                                  expected_rel_type: str,
                                  src_type: str = None, tgt_type: str = None,
    ...
    def test_02_simple_entity_extraction(self):
        ...
        self.assertGreaterEqual(len(nx_graph.nodes()), 1, "Should have at least 1 node in the graph")
    ...
    @pytest.mark.timeout(5)
    def test_09_noun_of_noun_org_has_attribute_different_tense(self):
    ...
    @pytest.mark.timeout(5)
    def test_10_works_for_relationship(self):
    ...
    @pytest.mark.timeout(5)
    def test_11_is_a_relationship(self):
    ...
    @pytest.mark.timeout(5)
    def test_12_possessive_relationship(self):
