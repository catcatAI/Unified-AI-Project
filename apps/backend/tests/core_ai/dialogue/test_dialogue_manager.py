...
async def test_get_simple_response_project_trigger(mock_core_services) -> None:
    ...
    _ = mock_core_services["llm_interface"].generate_response.assert_not_called()
...
async def test_start_session_greeting(mock_core_services) -> None:
    ...
    _ = time_system.get_time_of_day_segment.assert_called_once()
    _ = personality_manager.get_initial_prompt.assert_called_once()
...
async def test_get_simple_response_no_project_trigger(mock_core_services) -> None:
    ...
    # Act
    _ = await dm.get_simple_response(user_input)

    # Assert
    _ = project_coordinator.handle_project.assert_not_called()
...
async def test_get_simple_response_tool_dispatch_success(mock_core_services) -> None:
    ...
    _ = mock_core_services["ham_manager"].store_experience.assert_called()
...
async def test_get_simple_response_tool_dispatch_error(mock_core_services) -> None:
    ...
    # Assert
    assert response == expected_response
    _ = tool_dispatcher.dispatch.assert_awaited_once()
