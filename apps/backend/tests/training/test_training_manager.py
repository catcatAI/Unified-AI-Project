...
class TestTrainingManager:
    ...
    def test_demo_learning_manager_init(self, demo_learning_manager):
    ...
    @pytest.mark.asyncio
    async def test_demo_learning_manager_start_learning(self, demo_learning_manager):
        """测试开始学习"""
        # Mock依赖组件
    ...
    @pytest.mark.asyncio
    async def test_demo_learning_manager_stop_learning(self, demo_learning_manager):
        """测试停止学习"""
        # Mock依赖组件
        demo_learning_manager.model_trainer = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_execution_manager_execute_task(self, execution_manager):
        """测试执行任务"""
        task = {
    ...
    @pytest.mark.asyncio
    async def test_execution_manager_get_task_status(self, execution_manager):
        """测试获取任务状态"""
        task_id = "test_task_001"
    ...
    @pytest.mark.asyncio
    async def test_execution_manager_cancel_task(self, execution_manager):
        """测试取消任务"""
        task_id = "test_task_001"
    ...
    @pytest.mark.asyncio
    async def test_demo_learning_manager_get_model_status(self, demo_learning_manager):
        """测试获取模型状态"""
        model_id = "test_model"
    ...
    @pytest.mark.asyncio
    async def test_demo_learning_manager_list_models(self, demo_learning_manager):
        """测试列出模型"""
