...
class TestTrainingSystemIntegration(SystemIntegrationTest):
    ...
    async def test_model_training_integration(self):
        ...
        learning_manager.return_value.stop_training.assert_called_once()
    
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_auto_training_integration(self):
        """测试自动训练集成"""
        # 创建测试数据
        ...
        learning_manager.return_value.get_training_status.assert_called_once()
    
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_collaborative_training_integration(self):
        """测试协作式训练集成"""
        # 创建测试数据
        agent_configs = [
        ...
        learning_manager.return_value.aggregate_training_results.assert_called_once()
...
class TestIncrementalLearningIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_incremental_learning_integration(self):
        """测试增量学习集成"""
        # 创建测试数据
        ...
        # 验证mock调用
        llm_service.return_value.get_model_version.assert_called_once()
...
class TestTrainingDataManagementIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_training_data_pipeline_integration(self):
        """测试训练数据管道集成"""
        # 创建测试数据
        raw_data_samples = [
