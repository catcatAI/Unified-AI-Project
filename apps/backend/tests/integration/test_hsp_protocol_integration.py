...
class TestHSPProtocolIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.asyncio
    async def test_hsp_connection_integration(self):
        """测试HSP连接集成"""
        # 创建测试数据
        connection_config = {
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_hsp_message_publish_subscribe_integration(self):
        """测试HSP消息发布订阅集成"""
        # 创建测试数据
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_hsp_agent_communication_integration(self):
        """测试HSP代理通信集成"""
        # 创建测试数据
...
class TestHSPMessageRoutingIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_hsp_message_routing_integration(self):
        """测试HSP消息路由集成"""
        # 创建测试数据
        routing_messages = [
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_hsp_broadcast_integration(self):
        """测试HSP广播集成"""
        # 创建测试数据
...
class TestHSPQualityOfServiceIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_hsp_qos_integration(self):
        """测试HSP服务质量集成"""
        # 创建测试数据
