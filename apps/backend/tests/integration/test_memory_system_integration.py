...
class TestMemorySystemIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.asyncio
    async def test_memory_storage_retrieval_integration(self):
        """测试记忆存储和检索集成"""
        # 创建测试数据
        test_memories = [
...
class TestMemoryCompressionIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_memory_compression_integration(self):
        """测试记忆压缩集成"""
        # 创建测试数据
        detailed_memories = [
            self.data_factory.create_memory_item(
...
class TestMemorySemanticMappingIntegration(SystemIntegrationTest):
    ...
    @pytest.mark.system_integration
    @pytest.mark.asyncio
    async def test_memory_semantic_mapping_integration(self):
        """测试记忆语义映射集成"""
        # 创建测试数据
        semantic_memories = [
            self.data_factory.create_memory_item(
