...
class TestAgentManager:
    ...
    @pytest.mark.asyncio
    async def test_get_agent(self, agent_manager, mock_agent):
        """测试获取代理"""
        # 先添加代理
        await agent_manager.add_agent(mock_agent)
    ...
    @pytest.mark.asyncio
    async def test_start_all_agents(self, agent_manager, mock_agent):
        """测试启动所有代理"""
        # 添加多个代理
    ...
    def test_list_agents(self, agent_manager, mock_agent):
        """测试列出所有代理"""
        # 先添加代理
    ...
    def test_get_agent_status(self, agent_manager, mock_agent):
        """测试获取代理状态"""
        # 先添加代理
        asyncio.run(agent_manager.add_agent(mock_agent))
    ...
    @pytest.mark.asyncio
    async def test_agent_lifecycle(self, agent_manager):
        """测试代理生命周期"""
        factory = Mock()
        mock_agent = Mock(spec=BaseAgent)
