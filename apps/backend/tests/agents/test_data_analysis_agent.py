...
async def test_data_agent_handle_task_request_statistical_analysis(data_agent) -> None:
    ...
    # Call the handler
    _ = await data_agent.handle_task_request(task_payload, "sender_456", {})
    
    # Verify that a response was sent
    _ = data_agent.hsp_connector.send_task_result.assert_called_once()
...
async def test_data_agent_handle_task_request_data_processing(data_agent) -> None:
    ...
    # Call the handler
    _ = await data_agent.handle_task_request(task_payload, "sender_789", {})
...
async def test_data_agent_handle_task_request_unsupported_capability(data_agent) -> None:
    ...
    # Call the handler
    _ = await data_agent.handle_task_request(task_payload, "sender_202", {})
