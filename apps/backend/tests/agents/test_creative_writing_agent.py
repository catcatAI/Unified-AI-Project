...
async def test_creative_agent_handle_task_request_generate_marketing_copy(creative_agent) -> None:
    ...
    # Call the handler
    _ = await creative_agent.handle_task_request(task_payload, "sender_456", {})
    
    # Verify that a response was sent
    _ = creative_agent.hsp_connector.send_task_result.assert_called_once()
...
async def test_creative_agent_handle_task_request_polish_text(creative_agent) -> None:
    ...
    # Call the handler
    _ = await creative_agent.handle_task_request(task_payload, "sender_789", {})
...
async def test_creative_agent_handle_task_request_unsupported_capability(creative_agent) -> None:
    ...
    # Call the handler
    _ = await creative_agent.handle_task_request(task_payload, "sender_202", {})
...
async def test_creative_agent_generate_marketing_copy(creative_agent) -> None:
    ...
    _ = creative_agent.llm_interface.chat_completion.assert_called_once()
