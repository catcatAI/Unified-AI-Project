...
from apps.backend.src.agents.code_understanding_agent import CodeUnderstandingAgent
...
def test_code_agent_initialization(code_agent):
...
@pytest.mark.asyncio
async def test_code_agent_handle_task_request_analyze_code(code_agent):
...
@pytest.mark.asyncio
async def test_code_agent_handle_task_request_generate_documentation(code_agent):
...
@pytest.mark.asyncio
async def test_code_agent_handle_task_request_code_review(code_agent):
...
@pytest.mark.asyncio
async def test_code_agent_handle_task_request_unsupported_capability(code_agent):
...
def test_analyze_code_python(code_agent):
...
def test_generate_documentation(code_agent):
...
def test_perform_code_review(code_agent):
