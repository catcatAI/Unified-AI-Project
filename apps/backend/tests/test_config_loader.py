...
class TestConfigLoader(unittest.TestCase):
    ...
    def test_load_simulated_resources(self):
    ...
    def test_get_simulated_resources(self):
    ...
    def test_get_mock_placeholder_value_demo_mode(self):
    ...
    def test_get_mock_placeholder_value_non_demo_mode(self):
    ...
    def test_get_mock_placeholder_value_missing_key(self):
