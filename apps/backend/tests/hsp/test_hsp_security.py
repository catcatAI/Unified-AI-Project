...
class TestHSPSecurity:
    ...
    def test_sender_authentication(self, security_manager):
        """测试发送者身份验证"""
        sender_id = "did:hsp:test_ai_001"
    ...
    @pytest.mark.asyncio
    async def test_secure_message_processing(self, security_context):
        """测试安全消息处理"""
        # 创建测试消息
        message = {
            "message_id": "test_001",
    ...
    @pytest.mark.asyncio
    async def test_hsp_connector_secure_message_creation(self, hsp_connector):
        """测试HSP连接器安全消息创建"""
        # 创建测试载荷
    ...
    @pytest.mark.asyncio
    async def test_hsp_connector_secure_message_dispatch(self, hsp_connector):
        """测试HSP连接器安全消息分发"""
        # 创建测试消息
        message = {
            "message_id": "test_001",
