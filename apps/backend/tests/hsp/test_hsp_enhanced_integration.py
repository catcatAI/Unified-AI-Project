...
class TestHSPEnhancedIntegration:
    ...
    async def test_hsp_connector_message_queue_overflow(self, hsp_connector_fixture, mock_broker):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_hsp_connector_network_disconnect_recovery(self, hsp_connector_fixture, mock_broker):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_hsp_connector_large_message_handling(self, hsp_connector_fixture, mock_broker):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_hsp_connector_concurrent_subscriptions(self, hsp_connector_fixture, mock_broker):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_hsp_connector_message_ordering(self, hsp_connector_fixture, mock_broker):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_hsp_connector_error_handling(self, hsp_connector_fixture, mock_broker):
