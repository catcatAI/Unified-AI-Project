...
class TestAtlassianBridgeFallback:
    ...
    async def test_successful_primary_endpoint(self, monkeypatch, bridge) -> None:
        ...
        _ = monkeypatch.setattr(bridge, '_get_from_cache', mock_get_from_cache)
        
        # 重置 mock 並設置返回值
        _ = bridge.connector._make_request_with_retry.reset_mock()
        ...
        _ = bridge.connector._make_request_with_retry.assert_called_once()
    ...
    async def test_offline_queue_processing(self, bridge) -> None:
        ...
        # 處理隊列
        _ = await bridge.process_offline_queue()
    ...
    async def test_health_monitoring(self, bridge, monkeypatch) -> None:
        ...
        # 替換方法
        _ = monkeypatch.setattr(bridge, '_check_endpoint_health', mock_check_endpoint_health)
        
        # 執行測試方法
        _ = await bridge._check_endpoint_health('confluence', 'https://test.atlassian.net')
    ...
    async def test_force_endpoint_switch(self, bridge) -> None:
        ...
        # 強制切換
        _ = bridge.force_endpoint_switch('confluence')
    ...
    async def test_cache_with_get_requests(self, monkeypatch, bridge) -> None:
        ...
        _ = monkeypatch.setattr(bridge, '_save_to_cache', mock_save_to_cache)
        _ = monkeypatch.setattr(bridge, '_get_from_cache', mock_get_from_cache)
        ...
        # 第二次請求不應該調用 API
        _ = bridge.connector._make_request_with_retry.assert_not_called()
    ...
    async def test_offline_mode_with_expired_cache(self, monkeypatch, bridge) -> None:
        ...
        async def mock_make_request_with_fallback(service, method, endpoint, **kwargs):
            ...
            # 否則拋出異常
            _ = raise aiohttp.ClientError("All failed")
        
        _ = monkeypatch.setattr(bridge, '_make_request_with_fallback', mock_make_request_with_fallback)
        ...
        # 恢復原始方法
        _ = monkeypatch.setattr(bridge, '_make_request_with_fallback', original_method)
