...
2. `ValueError: Your currently installed version of Keras is Keras 3, but this is not yet supported in Transformers` -
   Transformers与Keras 3的兼容性问题
...
**使用方式**: 在需要使用Transformers或SentenceTransformer的文件中：
...
**RAGManager改进**: 添加了对SentenceTransformer不可用情况的处理：
