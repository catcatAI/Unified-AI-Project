...
def debug_matcher():
    ...
    for match_id, start, end in matches:
        ...
        if rule_id == "BASED_IN":
            ...
            # Check the direction of entity search - this is where the bug is
            print(f"      Searching for location entity (after 'in'):")
            location_token = None
            # This is the correct direction - look from 'in' to end of document
            ...
            subject_token = None
            # This is the correct direction - look backwards from pattern start
