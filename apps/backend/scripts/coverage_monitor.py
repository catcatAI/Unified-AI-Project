...
trend": "improving" if len(line_rates) > 1 and line_rates[-1] > line_rates[0] else "declining" if len(line_rates) > 1 and line_rates[-1] < line_rates[0] else "stable":, "branch_rate": {
