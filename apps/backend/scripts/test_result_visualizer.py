...
class TestResultVisualizer:
    ...
    def visualize_test_trends(self, results_data: List[Dict[str, Any]], output_file: str = "test_trends.png"):
        """
        可视化测试趋势
    ...
    def visualize_test_distribution(self, results_data: Dict[str, Any], output_file: str = "test_distribution.png"):
        """
        可视化测试分布情况
