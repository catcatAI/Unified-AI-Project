...
class FailurePattern:
    """失败模式类"""
    def __init__(self, pattern: str, count: int, affected_tests: List[str]):
...
class PerformanceRegression:
    """性能回归类"""
    def __init__(self, test_name: str, current_time: float, baseline_time: float, regression_ratio: float):
