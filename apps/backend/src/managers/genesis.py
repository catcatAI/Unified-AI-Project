...
class GenesisManager:
    ...
    _ = using a (2, 3) Shamir's Secret Sharing scheme.
    """
    ...
    Returns:
            A tuple containing:
            _ = - The Genesis Secret string (format: "UID:HAM_KEY").
    ...
    """
    _ = Splits the Genesis Secret into three shards using a (2, 3) scheme.
