...
# Backend providers extracted to services/llm/providers/ for A3 split
from services.llm.providers import (  # noqa: F401, E402
    BaseLLMBackend,
    LLMBackend,
    LlamaCppBackend,
    OllamaBackend,
...
from core.interfaces.protocols import ModelProvider, LLMResponse, ChatMessage  # noqa: F811, E402
...
# Prompt builder functions extracted to services/llm/prompt_builder.py for A3 split
