...
class MockCoreServices:
    ...
    def llm_interface_instance(self): return Mock()
    def hsp_connector_instance(self): return Mock()
    def get_multi_llm_service(self): return Mock()
    def tool_dispatcher_instance(self): return Mock()
    def dialogue_manager_instance(self): return Mock()
    def personality_manager_instance(self): return Mock()
    def emotion_system_instance(self): return Mock()
    def trust_manager_instance(self): return Mock()
    def service_discovery_instance(self): return Mock()
...
class HSPConnector: # Mock
    def __init__(self, ai_id, broker_address, broker_port): pass
    async def connect(self): return True
    async def disconnect(self): pass
    async def subscribe(self, topic, callback): pass
    def register_on_capability_advertisement_callback(self, callback): pass
