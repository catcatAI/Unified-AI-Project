...
在函数定义前添加空行
    ...
    CRITICAL level ( > {critical_thresh_gb:.2f}GB). Simulating {lag_to_apply_seconds:.2f}s lag.")
    ...
    NING level ( > {warning_thresh_gb:.2f}GB). Simulating {lag_to_apply_seconds:.2f}s lag.")
