...
try:
    ...
    logging.getLogger(__name__).warning(
        "ham_memory subpackage not available — some memory features disabled"
    )
...
from ai.memory.template_library import PredefinedTemplate, TemplateLibrary, get_template_library
