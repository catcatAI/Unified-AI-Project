...
class ExecutionManager:
    ...
    def __init__(self, config: Optional[ExecutionManagerConfig] = None) -> None:
        ...
        # Initialize execution monitor
        self.execution_monitor = ExecutionMonitor(config=monitor_config)
        self.monitor = ExecutionMonitor(config=monitor_config)
        ...
        **kwargs,
        ...
        if result is None:
            result = ExecutionResult(
                status=ExecutionStatus.ERROR, error_message="Unknown error occurred"
            )
