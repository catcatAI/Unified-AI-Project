...
class ResponseFusionEngine:
    ...
    def fuse(
        self, responses: List[LLMResponse], weights: Dict[str, float], strategy: str = "best_single"
    ) -> str:
    ...
    def _fuse_best_single(self, responses: List[LLMResponse], weights: Dict[str, float]) -> str:
    ...
    def _fuse_consensus(self, responses: List[LLMResponse], weights: Dict[str, float]) -> str:
    ...
    def _fuse_creative_blend(self, responses: List[LLMResponse], weights: Dict[str, float]) -> str:
...
class ModelEnsemble:
    ...
    def configure_ensemble(self, models: List[ModelWeight]):
        ...
        self.weights = {m.model_id: m.weight / total_weight for m in models}
    ...
    async def _query_model_safe(self, model_id: str, messages: List[ChatMessage]) -> LLMResponse:
    ...
    async def streaming_ensemble(
        self, prompt: str, messages: Optional[List[ChatMessage]] = None
