...
async def main():
    ...
    try:
        ...
        if asi_system.autonomous_alignment:
            ...
            # 获取自主对齐状态
            autonomous_status = await asi_system.autonomous_alignment.get_alignment_status()
        ...
        if asi_system.distributed_coordinator:
            ...
            # 获取分布式状态
            distributed_status = await asi_system.distributed_coordinator.get_cluster_status()
        ...
        if asi_system.parameter_cluster:
            ...
            # 获取参数
            retrieved_param = await asi_system.parameter_cluster.get_parameter("demo_parameter_001")
