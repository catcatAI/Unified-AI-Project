...
class DeepMapper:
    ...
    Args:
            _ = mapping_rules (Optional[Dict[str, Any]]) The mapping rules.
    """
    ...
    Args:
            _ = filepath (str) The path to the mapping rules file.
    """
    ...
    Args:
            _ = mdo (MappableDataObject) The MappableDataObject to map.
    ...
    Args:
            _ = mdo (MappableDataObject) The MappableDataObject to reverse map.
