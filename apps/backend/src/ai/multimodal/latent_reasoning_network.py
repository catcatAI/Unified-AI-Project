...
class LatentReasoningNetwork:
    ...
    def _build_vocab(self) -> List[str]:
        ...
        words = [
            ...
            "team", "minute", "idea", "body", "back", "parent", "face", "others",
            ...
            # Common verbs
            "go", "come", "make", "take", "know", "get", "give", "find", "tell",
            ...
            "best", "recent", "certain", "personal", "open", "strong", "possible",
            "whole", "short", "low", "local", "single", "hard", "simple", "fast",
            "slow", "hot", "cold", "warm", "light", "dark", "heavy", "beautiful",
            "happy", "sad", "angry", "scared", "tired", "sick", "healthy",
            # Common responses
            "yes", "no", "okay", "ok", "sure", "thanks", "thank", "please",
            "sorry", "hello", "hi", "hey", "bye", "goodbye", "well", "right",
            "exactly", "absolutely", "definitely", "probably", "maybe", "perhaps",
            "actually", "basically", "simply", "just", "also", "too", "very",
            "really", "quite", "pretty", "much", "many", "some", "any", "all",
            "every", "each", "both", "neither", "either", "none",
            # Question words
            "who", "what", "where", "when", "why", "how", "which", "whose",
            # Prepositions
            "in", "on", "at", "to", "for", "with", "from", "by", "about",
            "as", "into", "through", "during", "before", "after", "above",
            "below", "between", "under", "over", "of", "and", "but", "or",
            "not", "no", "if", "then", "than", "so", "because", "while",
            "although", "though", "since", "until", "unless", "except",
            # Punctuation
            ".", ",", "!", "?", ":", ";",
            # Chinese basics
            "你好", "谢谢", "对不起", "没关系", "好的", "是的", "不是",
            "我", "你", "他", "她", "它", "我们", "你们", "他们",
            "是", "有", "在", "不", "了", "的", "和", "就", "人", "都",
            "什么", "怎么", "为什么", "哪里", "谁", "多少", "几",
            "今天", "明天", "昨天", "现在", "以后", "以前",
            ...
            "喜欢", "想", "要", "会", "能", "可以", "应该", "必须",
            # Common phrases
            "i don't know", "i'm not sure", "that's interesting",
            "tell me more", "i understand", "good question",
            "let me think", "that makes sense", "i agree", "i disagree",
            "can you explain", "what do you mean", "how does that work",
            "that's a good point", "i see", "really", "that's amazing",
            "that's terrible", "i'm sorry", "how are you", "i'm fine",
            "what's up", "not much", "let's go", "see you later",
        ]
    ...
    def train_batch(self, batch_size: int = 32, lr: float = 0.001) -> float:
        ...
        indices = np.random.choice(
            ...
            size=min(batch_size, len(self._training_data)),
            replace=False
        )
