...
class GamePolicy:
    ...
    def __init__(self, config: Optional[PolicyConfig] = None):
        ...
        self._action_map = {
            # 連續動作 (16 維)
            "move_forward": 0, "move_strafe": 1, "move_yaw": 2,
            "look_yaw": 3, "look_pitch": 4,
            "dig_yaw": 5, "dig_pitch": 6,
            "place_yaw": 7, "place_pitch": 8,
            "nav_yaw": 9, "nav_pitch": 10, "nav_forward": 11,
            "combat_yaw": 12, "combat_pitch": 13, "combat_strafe": 14,
            "build_yaw": 15,
            # 離散動作 (8 維)
            "discrete_attack": 0, "discrete_use": 1, "discrete_jump": 2,
            "discrete_sprint": 3, "discrete_sneak": 4,
            "discrete_inventory": 5, "discrete_craft_grid": 6, "discrete_craft_output": 7
        }
    ...
    def forward(self, 
                ...
                visual_features: Optional[np.ndarray] = None) -> PolicyOutput:
        """
        前向傳播
    ...
    def get_grounding_click(self, output: PolicyOutput, inverse_map: np.ndarray) -> Optional[Tuple[int, int]]:
        """
