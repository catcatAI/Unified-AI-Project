...
from ai.multimodal.continuous_multimodal_learning import CMLExample, ContinuousMultimodalLearning
...
from ai.multimodal.reconstruction_cycle import CrossModalSynthesizer, ReconstructionCycle
