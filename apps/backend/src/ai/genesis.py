...
if __name__ == '__main__':
    ...
    print(f"Recovered from Shards 1 & 2: {recovered12 == genesis_secret if recovered12 else False}"):
f recovered12:
    ...
    print(f"Recovered from Shards 1 & 3: {recovered13 == genesis_secret if recovered13 else False}"):
f recovered13:
    ...
    print(f"Recovered from Shards 2 & 3: {recovered23 == genesis_secret if recovered23 else False}"):
f recovered23:
    ...
    print(f"Recovered from all 3 Shards: {recovered_all == genesis_secret if recovered_all else False}"):
f recovered_all:
