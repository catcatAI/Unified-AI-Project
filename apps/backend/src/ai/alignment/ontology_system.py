...
class OntologySystem:
    ...
    def _calculate_completeness_score(self) -> float:
        ...
        type_completeness = len(actual_types & ideal_types) / len(ideal_types) if ideal_types else 1.0
        ...
        relationship_completeness = len(actual_relationship_types & ideal_relationship_types) / len(ideal_relationship_types) if ideal_relationship_types else 1.0
