...
class DynamicAgentRegistry:
    ...
    Args:
            ...
            :
    Returns: List[...] List of agents with the specified capability
    """
    async with self.registry_lock:
    matching_agents = []
    ...
    Returns: List[...] List of agents with matching names
    """
    async with self.registry_lock:
    matching_agents =
            for agent in self.registered_agents.values:
    ...
    Returns: List[...] List of all active agents
    """
    async with self.registry_lock:
    ...
    async def get_agents_with_capabilities(self, required_capabilities: List[...]
    """
    ...
    Returns: List[...] List of agents with all required capabilities
    """
    async with self.registry_lock:
    matching_agents =
            for agent in self.registered_agents.values:
