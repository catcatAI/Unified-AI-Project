...
class StreamToken:
    ...
    @classmethod
    def create_predicted(
        cls, content: str, source: str, confidence: float = 0.6, **kwargs
    ) -> "StreamToken":
    ...
    @classmethod
    def create_retrieved(
        cls, content: str, source: str, confidence: float = 0.8, **kwargs
    ) -> "StreamToken":
    ...
    def create_generated(
        cls, content: str, source: str, confidence: float = 0.9, **kwargs
    ) -> "StreamToken":
    ...
    @classmethod
    def create_synthesized(
        cls, content: str, source: str = "synthesizer", **kwargs
    ) -> "StreamToken":
