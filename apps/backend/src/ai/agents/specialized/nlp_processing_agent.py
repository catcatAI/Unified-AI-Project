...
class NLPProcessingAgent(BaseAgent)
    ...
    def _generate_text_summary(self, params: Dict[...]
    ...
    def _perform_sentiment_analysis(self, params: Dict[...]
    ...
    def _extract_entities(self, params: Dict[...]
    ...
    def _detect_language(self, params: Dict[...]
