...
class PlanningAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str) -> None:
        capabilities = [
            {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "object",
                        "required": False,
                        "description": "Time/resource constraints",
                    },
                ],
                "returns": {
                    "type": "object",
                    "description": "Detailed plan with tasks and timeline.",
                },
            },
            {
        ...
        self.register_task_handler(
            f"{agent_id}_schedule_optimization_v1.0", self._handle_schedule_optimization
        )
