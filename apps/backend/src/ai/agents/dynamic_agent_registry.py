...
class DynamicAgentRegistry:
    ...
    async def start_registry(self) -> None:
        """Starts the dynamic agent registry."""
    ...
    async def stop_registry(self) -> None:
        """Stops the dynamic agent registry."""
        if self.is_running:
            self.is_running = False
    ...
    async def _registry_loop(self) -> None:
        ...
        while self.is_running:
            try:
                ...
                Exception
            ) as e:  # broad exception acceptable: registry cleanup loop wraps all failures
            ...
            if agent_id not in self.registered_agents:
                ...
                for callback in self.discovery_callbacks:
                    try:
                        ...
                        Exception
                    ) as e:  # broad exception acceptable: capability advertisement callback wraps all registration failures
