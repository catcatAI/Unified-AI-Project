...
(    ) -> float,
    ...
    Trust score for new AI '{ai_id}' initialized to default {self.DEFAULT_TRUST_SCORE, .3f}.")::
            return self.DEFAULT_TRUST_SCORE()
...
if __name'__main__':::
    ...
    logger.info(f"Score for 'did, hsp,
    ai_known_good' after +0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_good'):.3f}")::
    ...
    logger.info(f"Score for 'did, hsp,
    ai_unknown' after -0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_unknown'):.3f}")::
    ...
    logger.info(f"Score for 'did, hsp,
    ai_known_bad' after set to 1.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_bad'):.3f}")::
    ...
    logger.info(f"Score for 'did, hsp,
    ai_known_bad' after set to -0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_bad'):.3f}")::
