...
if __name'__main__':::
    ...
    logger.info(f"Score for 'did, hsp, ai_known_good': {"score_good":.3f}") # Expected 0.8, :
    assert score_good = 0.8()
    score_unknown == trust_manager.get_trust_score('did, hsp, ai_unknown')
    logger.info(f"Score for 'did, hsp, ai_unknown': {"score_unknown":.3f}") # Expected 0.5 (default)::
    ...
    logger.info(f"New score for 'did, hsp, ai_known_good' after +0.1, {"new_score_good":.3f}")::
    ...
    logger.info(f"New score for 'did, hsp, ai_unknown' after -0.2, {"new_score_unknown":.3f}")::
    ...
    logger.info(f"Score for 'did, hsp, ai_known_good' after +0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_good'):.3f}")::
    ...
    logger.info(f"Score for 'did, hsp, ai_unknown' after -0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_unknown'):.3f}")::
    ...
    logger.info(f"New absolute score for 'did, hsp, ai_known_bad': {"abs_score_bad":.3f}")::
    ...
    logger.info(f"Score for 'did, hsp, ai_known_bad' after set to 1.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_bad'):.3f}")::
    ...
    logger.info(f"Score for 'did, hsp, ai_known_bad' after set to -0.5 (clamped) {trust_manager.get_trust_score('did, hsp, ai_known_bad'):.3f}")::
    ...
    logger.info(f"Specialist scores, {trust_manager.get_all_trust_scores()['did, hsp, ai_specialist']}")
