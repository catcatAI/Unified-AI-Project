...
from .storage.base_fixed import
    ...
    ::
            ...
            for context_id in filtered_context_ids, ::
                ...
                if context, ::
                    ...
                    if query.lower() in content_str.lower() or \
    query.lower() in metadata_str.lower():::
        ...
        try,
            ...
            if filter_criteria, ::
                ...
                for key, value in data_to_transfer.items():::
                    if key in filter_criteria and \
    data_to_transfer[key] == filter_criteria[key]::
