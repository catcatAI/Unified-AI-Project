...
class SecurityAudit:
    ...
    def scan_file(self, file_path: str) -> Dict[str, Any]:
        ...
        return {"file": file_path, "vulnerabilities": vulnerabilities}

    def scan_directory(
        self, directory: Optional[str] = None, file_pattern: str = "*.py"
    ) -> Dict[str, Any]:
        """扫描目录"""
    ...
    def _calculate_security_score(
        self, vulnerabilities_by_severity: Dict[str, List[Dict[str, Any]]]
    ) -> int:
        """计算安全分数"""
