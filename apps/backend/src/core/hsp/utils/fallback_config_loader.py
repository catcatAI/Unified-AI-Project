    ...
    DEFAULT_CONFIG = {
        "hsp_fallback": {
            ...
            "protocols": {
                ...
                "memory": {"priority": 1, "enabled": True, "queue_size": 1000},
            },
            "message": {"default_max_retries": 3, "default_ttl": 300, "health_check_interval": 30},
            "logging": {"level": "INFO", "log_fallback_usage": True, "log_protocol_switches": True},
        },
        "hsp_primary": {
            "mqtt": {
            ...
            "connection": {"timeout": 10, "reconnect_interval": 5, "max_reconnect_attempts": 3},
            "health_check": {"interval": 60, "timeout": 5},
        },
    }
