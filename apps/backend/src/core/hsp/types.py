...
class HSPFactPayload(TypedDict, total=False):
    ...
    statement_nl: str
    statement_structured: Union[HSPFactStatementStructured, Dict[str, Any]]  # Dict for json_ld
...
class HSPOpinionPayload(TypedDict, total=False):
    ...
    justification: Optional[Union[str, List[str]]]  # Text, or ID, or list of IDs
