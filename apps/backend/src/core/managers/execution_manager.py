...
- V (Vitality): L3-L4 - Execution lifecycle and health management
- L (Learning): L2-L3 - Adaptive timeout and resource learning
- P (Processing): L3-L4 - Command execution and monitoring
- M (Memory): L2-L3 - Execution history and issue tracking
"""
