...
async def test_safety_controls():
    ...
    safety = SafetyControls(blacklist=["malicious-site.com"], max_session_duration=60)
...
async def test_browser_manager():
    ...
    config = BrowserConfig(
        browser_type=BrowserType.CHROME, framework=AutomationFramework.PLAYWRIGHT, headless=True
    )
