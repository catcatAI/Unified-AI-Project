...
def _demo_state_matrix(sm: StateMatrixAdapter) -> None:
    """Demonstrate 6D state matrix capabilities."""
...
def _demo_theta_meta_cognition(sm: StateMatrixAdapter) -> None:
    """Demonstrate theta meta-cognition axis."""
...
def _demo_temporal_queries(sm: StateMatrixAdapter) -> None:
    """Demonstrate temporal state queries."""
...
def _demo_influence_computation(sm: StateMatrixAdapter) -> None:
    """Demonstrate influence computation."""
...
def _demo_allocation_decision(sm: StateMatrixAdapter) -> None:
    """Demonstrate allocation decision."""
...
def _demo_ripple_cascade(sm: StateMatrixAdapter) -> None:
    """Demonstrate ripple cascade."""
...
def _demo_attractor_field_navigation(sm: StateMatrixAdapter) -> None:
    """Demonstrate attractor field navigation."""
...
def _demo_state_persistence(sm: StateMatrixAdapter) -> None:
...
def _demo_attractor_management(sm: StateMatrixAdapter) -> None:
    """Demonstrate attractor management."""
...
def _demo_full_report(sm: StateMatrixAdapter) -> None:
...
def _demo_fastapi_endpoints() -> None:
