...
class Client:
    def __init__(
        self, client_id: str, clean_session: bool = True, transport: str = "tcp"
    ) -> None: ...
    ...
    async def connect(
        self, host: str, port: int = 1883, ssl: Any = None, keepalive: int = 60
    ) -> None: ...
    async def disconnect(self) -> None: ...
    async def publish(
        self, topic: str, payload: Any, qos: int = 0, retain: bool = False, properties: Any = None
    ) -> None: ...
