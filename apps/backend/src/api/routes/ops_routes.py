...
():
    ...
    try,
        ...
        success = await maintenance.approve_maintenance_schedule(schedule_id, approved_by)
...
():
    ...
    try,
        ...
        success = await optimizer.implement_optimization_recommendation(recommendation_id, implemented_by)
