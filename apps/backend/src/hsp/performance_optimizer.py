...
class HSPPerformanceOptimizer:
    ...
    def _identify_bottlenecks(self, stats: Dict[str, Union[str, int, float, NetworkStats, Dict[str, Any]]]) -> List[str]:
        """识别性能瓶颈"""
    ...
    def _generate_optimization_recommendations(self, stats: Dict[str, Union[str, int, float, NetworkStats, Dict[str, Any]]]) -> List[Dict[str, str]]:
        """生成优化建议"""
