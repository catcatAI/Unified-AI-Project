...
class LogicNNModel:
    ...
    def __init__(self, max_seq_len: int, vocab_size: int, embedding_dim: int = 32, lstm_units: int = 64):
...
(        )
    ...
    def predict(self, proposition_str: str, char_to_token: Dict[str, int]) -> Optional[LogicModelResult]:
