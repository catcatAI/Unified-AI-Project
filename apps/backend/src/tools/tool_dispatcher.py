...
(            )
    ...
    #         resolved_target_lang = kwargs.get("target_language", "en") # Default to English
    ...
    #                     resolved_target_lang = lang_name_or_code
    #             else:
    #                 # Final Fallback: just "translate TEXT" (assume target is default English)
...
(    #             )
    ...
    #         
    #         if "Translation not available", in result_payload or "error", in result_payload.lower() or "not supported", in result_payload.lower():
    #             return ToolDispatcherResponse()
    #                 status="failure_tool_error",
    #                 payload=None,
    #                 tool_name_attempted="translate_text",
