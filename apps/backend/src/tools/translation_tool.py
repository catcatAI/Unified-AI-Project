...
ould be expanded or replaced with a more robust library.:
""
...
arget_language (str): The target language name or code (e.g., 'en', 'zh', 'english').
...
or k_loop in dictionary.keys():  # Iterate over original keys
...
or k, v in dictionary[translation_map_key].items():
...
n v0.1, this just prints a message.
