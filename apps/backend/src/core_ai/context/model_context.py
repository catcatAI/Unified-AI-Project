...
class AgentCollaboration:
    ...
    def __init__(self, task_id: str, participating_agents: List[str]):
...
class CollaborationStep:
    ...
    def __init__(self, agent_id: str, action: str, input_data: Any, output_data: Any):
        ...
        try:
            ...
            context_content = {
                "collaboration_completion": {
                    "collaboration_id": collaboration_id,
                    "end_time": collaboration.end_time.isoformat(),
                    "status": collaboration.status,
