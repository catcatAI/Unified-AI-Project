...
class EconomyManager:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.item_registry = {
            ...
            "premium_bio_pellets": {
                "price": 10.0,
                "restores": {"hunger": 30, "happiness": 5},
                "description": "High quality food",
            },
            "viral_toy_update": {
                "price": 15.0,
                "restores": {"happiness": 40},
                "description": "Boosts mood significantly",
            },
            "system_optimizer_patch": {
                "price": 25.0,
                "restores": {"energy": 50, "happiness": 10},
                "description": "Full system rejuvenation",
            },
            "medical_kit": {
                "price": 20.0,
                "restores": {"health": 30},
            ...
            "toy": {
                "price": 8.0,
                "restores": {"happiness": 20},
                "description": "A simple toy for fun",
            },
        }
    ...
    def process_cognitive_dividend(
        self, user_id: str, life_sense_amount: float, quality_score: float
    ) -> float:
        ...
        if dividend_amount > 0:
            ...
            logger.info(
                f"Awarded cognitive dividend of {dividend_amount:.2f} coins to user '{user_id}' (Life Sense: {life_sense_amount:.2f}, Quality: {quality_score:.2%})"
            )
