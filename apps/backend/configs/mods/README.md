...
This directory is reserved for non-standard extensions, third-party plugins, and
...
Add your mod configuration files here. The system will automatically detect and
merge them into the `mods` tier if referenced in `active_mods`.
