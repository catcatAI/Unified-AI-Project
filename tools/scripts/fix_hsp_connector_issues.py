...
def fix_hsp_connector_syntax_issues():
    ...
    try,
        ...
        content = content.replace("await self.fallback_manager.shutdown()", "await self.fallback_manager.shutdown()")
        
        # 修复 self.fallback_manager.start 为 await self.fallback_manager.start()
        content = content.replace("await self.fallback_manager.start", "await self.fallback_manager.start()")
