    ...
    for file_path in python_files,::
        ...
        if unused_imports,::
            ...
            for imp in unused_imports,::
                if imp['type'] == 'import':::
                    print(f"  第 {imp['line']} 行, import {imp['name']}")
                else,
                    print(f"  第 {imp['line']} 行, from {imp['module']} import {imp['name']}")
    
    print(f"\n检查完成,")
    print(f"  发现 {files_with_unused} 个文件包含未使用的导入")
    print(f"  总共 {total_unused} 个未使用的导入")
