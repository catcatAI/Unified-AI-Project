...
| #201b | MD sync + orphan cleanup + usage docs. (1) MD test count sync (5,016→4,439, 5 files). (2) Deleted orphan dirs + 4 dead test files. (3) Repaired test_phase1_core_activation.py. (4) Moved 23 utility scripts tests/utils/→scripts/utils/ (2 earlier + 21 now). (5) Fixed test_base.py: __test__=False + Any import. (6) Created docs/usage/ (QUICK_START.md, SCENARIOS.md). (7) README.md cross-refs. 4,439 tests — 0 errors. | 維護+品質+文檔 | 無 C³ 影響 |
