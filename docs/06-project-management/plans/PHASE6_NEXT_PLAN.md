...
> P6-1, P6-2, P6-4, P7-1, P7-2 ✅ all done. P6-3 (magic number migration) 🟡 partial (~32 formulae remain in code, 76 values moved to configs). This plan is superseded by the MASTER_TASK_MAP for tracking remaining work.  
