...
> **Test count baseline**: `pytest` tests/ only = **4,396 collected / 0 errors** (last verified after §X #207: test dedup -2 files, -141 lines). Breakdown: tests/core/: 875 pass, 53 skip, 0 fail. tests/unit/: 739 pass (was 741, -2 from dedup).
