...
| 6 | P4 long function refactor (31 total >100L found) | 15/31 done (+AgentManager._start_router: 132→22L, extracted _ROUTER_SCRIPT module-level constant + _wait_router_health helper, Jun 28). 16 functions >100 lines remain. | 16 functions >100 lines; 15 refactored | Effort (large) |
