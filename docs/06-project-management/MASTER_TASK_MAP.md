...
| 6 | P4 long function refactor (31 total >100L found) | 21/31 done (+initialize: 135L→orchestrator + 5 helpers: _try_auto_mode, _initialize_standard_mode, _pick_best_backend, _init_model_bus, _register_model_bus_handlers, _init_meta_controller, Jun 28). 10 functions >100 lines remain. | 10 functions >100 lines; 21 refactored | Effort (large) |
