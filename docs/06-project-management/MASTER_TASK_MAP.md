...
| **P4 (31 long function refactor)** | ...SelfGeneration._simulate_generation 103→13 (Jun 28) | 14 functions >100 lines remain (Jun 28 empirical scan, unique count) | 🟡 **17/31 done** |
...
| 6 | P4 long function refactor (31 total >100L found) | 17/31 done (+SelfGeneration._simulate_generation: 103→13L, extracted 4 helpers: _try_learning_workflow, _try_live2d_generator, _try_sd_api, _fallback_generation, Jun 28). 14 functions >100 lines remain. | 14 functions >100 lines; 17 refactored | Effort (large) |
