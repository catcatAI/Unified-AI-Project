...
> **Test count baseline**: `pytest` tests/ only = **4,398 collected / 0 errors** (R1-R10: -2,878 lines across 40+ files) on 2026-07-07 (verified after §X #201-201b: lazy imports fix + orphan cleanup + dead test removal + MD sync). tests/core/: 875 pass, 53 skip, 0 fail. tests/unit/: 741 pass.
...
### §X #204: Deep audit R1-R10 (2026-07-08)
...
- **Net**: -2,878 lines across all rounds.
