...
> **Test count baseline**: `pytest` tests/ only = **4,398 collected / 0 errors** (R1-R13: -2,861 lines across 50+ files) on 2026-07-08 (verified after §X #204: deep audit + bug fixes + test consolidation). tests/core/: 875 pass, 53 skip, 0 fail. tests/unit/: 741 pass.
