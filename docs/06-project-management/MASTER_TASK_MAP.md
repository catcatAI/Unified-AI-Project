...
| **P4 (31 long function refactor)** | QueryClassifier.__init__ 187→7, HAMDataProcessor._abstract_text 133→72, HAMQueryEngine._fallback_keyword_search 107→65, construct_angela_prompt F48→D27, QueryClassifier.classify 106→40, DictionaryClassifier.classify 106→25, lifespan 140→16, HAMQueryEngine.retrieve_relevant_memories 101→32, DifferentiableRenderer.render 101→22, AgentManager._start_router 132→22, Decomposer.decompose_spatial 102→20 (Jun 28) | 15 functions >100 lines remain (Jun 28 empirical scan, unique count) | 🟡 **16/31 done** |
...
| 6 | P4 long function refactor (31 total >100L found) | 16/31 done (+Decomposer.decompose_spatial: 102→20L, extracted 3 helpers: _extract_planes_and_circles, _extract_boundary_points, _extract_edge_lines, Jun 28). 15 functions >100 lines remain. | 15 functions >100 lines; 16 refactored | Effort (large) |
