...
> **Test count baseline**: `pytest` tests/ only = **4,488 collected / 0 errors** (last verified after SNN memory-bound eviction + Save/Load fix: 10 new regression tests)+ route fix + test README update).
