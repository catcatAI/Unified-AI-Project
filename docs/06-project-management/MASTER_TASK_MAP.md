...
| 6 | P4 long function refactor (31 total >100L found) | 14/31 done (+DifferentiableRenderer.render: 101→22L, extracted 6 helpers: _layer, _render_planes, _render_circles, _render_arcs, _render_lines, _render_points, Jun 28). 17 functions >100 lines remain. | 17 functions >100 lines; 14 refactored | Effort (large) |
