...
> **备份说明**: 此文档已备份至
> `backup_20250903/script_analysis/SCRIPTS_DOCUMENTATION.md.backup`，作为历史记录保存。
>
> **状态**: 问题已解决，此文档仅供历史参考。
...
本文档提供了Unified AI
Project项目中所有脚本的详细说明和使用指南，包括pnpm指令、批处理脚本、PowerShell脚本和Python脚本。
...
(`unified-ai-cli.bat`) 是一个新的统一命令行工具，整合了项目管理的所有功能。
...
4. 如遇Git问题，使用 `unified-ai-cli.bat git fix` 或紧急修复
   `unified-ai-cli.bat git emergency`
