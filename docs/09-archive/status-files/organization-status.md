...
> **⚠️ 此文檔已過時。** 最後整理於2025年1月，以下資訊與當前代碼不符：
> - 源代碼在 `apps/backend/src/`（~500 個 Python 檔案），非 `src/`（167 個）
> - 無 `core_ai/`, `tools/`, `game/` 目錄
> - 核心框架為 **FastAPI**，非 Flask
> - langchain 不在任何依賴中
> - 請參考 `docs/analysis/ARCHITECTURE_MAP_2026-05-20.md`

## 📋 專案概覽

**專案名稱**: Unified AI Project  
**版本**: 0.1.0  
**整理日期**: 2026年5月20日 (原始: 2025年1月18日)  
**狀態**: ⚠️ 部分資訊過時，見上方警告
