...
- 在 [tools\run-backend-tests.bat](../../../../..)
  原位置创建一个重定向脚本（如果需要保持向后兼容）

#### 实施步骤

1. 备份 [tools\run-backend-tests.bat](../../../../..)
2. 增强 [scripts\run_backend_tests.bat](../../../../..) 以包含
   [tools\run-backend-tests.bat](../../../../..) 的功能
...
- 将 [unified-ai-enhanced.bat](../../../../..) 的功能整合到
  [unified-ai.bat](../../../../..)
