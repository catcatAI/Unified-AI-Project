...
Version: v1.0 Date: 2025-08-06 Owners: PM / Tech Leads

## 1. Goal

Unify experience and practices across sub-projects (backend, frontend-dashboard,
desktop-app, cli) by leveraging strengths and eliminating duplication.
