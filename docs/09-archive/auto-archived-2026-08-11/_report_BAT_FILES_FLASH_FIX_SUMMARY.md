...
在 [start-dev.bat](../../../tools/start-dev.bat) 和
[ai-runner.bat](../../../ai-runner.bat) 中，我们修复了 `start` 命令的使用：
...
新增了 [tools\view-error-logs.bat](../../../tools/view-error-logs.bat)
...
通过使用 [tools\view-error-logs.bat](../../../tools/view-error-logs.bat)
