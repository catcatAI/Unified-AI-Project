...
This document catalogs all changes made during the **LLM Pipeline Repair
Session** (2026-05-19), distinguishes correct repairs from accidental/wrong
modifications, and documents the restoration steps taken.
...
After reverting all wrong changes, 23 files remain modified with clean,
purposeful changes:
...
1. **Math Engine**: `2 的 10 次方` parsed as `2+10=12` — exponentiation not
   recognized
