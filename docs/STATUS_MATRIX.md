...
| mypy 型別債 | 收斂中（棘輪門鎖定） | `pyproject.toml`<br>`scripts/mypy_budget_gate.py`<br>`scripts/mypy_budget.txt` | **verified** | `python scripts/mypy_budget_gate.py`；門機制可驗證；基線 432（R83 鎖定；歷史 559→540→518→497→476→R83 長尾收割 11 檔→432）；新增債 CI 直接紅燈 | 2026-09-22 |
