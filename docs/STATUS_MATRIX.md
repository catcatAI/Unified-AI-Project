...
| mypy 型別債 | 收斂中（棘輪門鎖定） | `pyproject.toml`<br>`scripts/mypy_budget_gate.py`<br>`scripts/mypy_budget.txt` | **verified** | `python scripts/mypy_budget_gate.py`；門機制可驗證；基線 402（R86 鎖定；歷史 559→540→518→497→476→432→405→402）；新增債 CI 直接紅燈 | 2026-09-22 |
