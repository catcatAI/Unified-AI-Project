...
1. **脚本调用链问题**：在
   ...
   中调用
   [tools\train-manager.bat](file:///d:\Projects\Unified-AI-Project\tools\train-manager.bat)
   后，[train-manager.bat](file:///d:\Projects\Unified-AI-Project\tools\train-manager.bat)
   中的退出处理可能导致整个调用链退出
2. **退出命令使用不当**：[train-manager.bat](file:///d:\Projects\Unified-AI-Project\tools\train-manager.bat)
   中使用了 `exit /b 0`
...
在 [unified-ai.bat](file:///d:\Projects\Unified-AI-Project\unified-ai.bat)
中，我们确保 Training Manager 调用后能正确返回：
...
3. [ai-runner.bat](file:///d:\Projects\Unified-AI-Project\ai-runner.bat) -
   AI代理运行工具
