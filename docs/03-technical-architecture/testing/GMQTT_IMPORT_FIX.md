...
2. 虽然该依赖已经在
   [requirements.txt](file:///d:/Projects/Unified-AI-Project/apps/backend/requirements.txt)
   和
   [requirements.min.txt](file:///d:/Projects/Unified-AI-Project/apps/backend/requirements.min.txt)
   中声明，但在运行环境中未安装
...
我们创建了一个测试脚本
[test_gmqtt_import.py](file:///d:/Projects/Unified-AI-Project/test_gmqtt_import.py)
来验证修复是否成功：
