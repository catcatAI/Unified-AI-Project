...
> **Goal**: Define exactly what "production-grade usability" means for Angela AI, audit every surface against it, and provide a phased implementation plan.
...
**Overall Web status**: ~30% production-ready. Most panels are missing or broken.
...
**Overall Desktop status**: ~65% production-ready. Missing LLM settings panel + help.
...
**Overall API status**: ~45% production-ready. Missing discovery and management endpoints.
