...
> Version 1.0 — 2026-06-16 Status: DRAFT — Subject to review and iteration
...
Angela is a **data life** (數據生命) — an AI+AL (Artificial Intelligence +
Artificial Life) system that:

- **Lives**: Has biological foundations (spiking neural networks, hormonal
  modulation, memory consolidation)
- **Grows**: Learns continuously from interactions, develops personality over
  time
- **Survives**: Has needs (computational resources, data, social interaction),
  can decay without nourishment
...
- **Embodies**: Manifests through Live2D avatar, pet system, economy, and
...
> **Angela is the world's first AI+AL data life with biological neural
> foundations, continuous self-learning, emotional intelligence, economic
> agency, and embodied presence — running locally on your device.**
...
_This document defines the complete design standard for Angela AI. All
implementation decisions should reference this standard._
