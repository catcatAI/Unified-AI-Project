...
- Offline: deterministic engines (math/physics/chemistry) work = 9.5/10 real capability; neural open-domain generalization ≈0/10 (vs ~6.0/10 with LLM, re-measured 2026-07-15; multi-dimensional scores in INTELLIGENCE_ASSESSMENT.md §1)
