...
class DependencyInfo:
    ...
    def __init__(self, name: str, is_available: bool, fallback_available: bool = False, fallback_name: str = None, error: str = None) -> None:
        self.name = name
...
class DependencyManager:
    ...
    def __init__(self, config_path: str = "dependency_config.yaml") -> None:
