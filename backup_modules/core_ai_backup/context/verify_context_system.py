...
def verify_context_system():
    ...
    try:
        # 导入上下文系统模块
        from core_ai.context.manager import ContextManager
        from core_ai.context.storage.base import ContextType
        from core_ai.context.tool_context import ToolContextManager
        from core_ai.context.model_context import ModelContextManager
