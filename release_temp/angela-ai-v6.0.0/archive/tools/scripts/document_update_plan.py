...
# 忽略的目錄
IGNORE_DIRS = [
    ".git", ".github", "node_modules", "__pycache__", "data/runtime_data/.pytest_cache",
...
def scan_directory(directory, str, patterns, List[str]) -> List[str]
    """掃描目錄並返回符合模式的文件列表
...
def associate_files(code_files, List[str] doc_files, List[str]) -> Dict[str, List[str]]
    """建立代碼文件和文檔文件的關聯
