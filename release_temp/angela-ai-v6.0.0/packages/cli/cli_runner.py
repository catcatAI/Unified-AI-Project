...
def main():
    ...
    sys.path.insert(0, str(script_dir.parent)) # Corrected to .parent and removed duplicate
    ...
    try:
        ...
        try:
            ...
            parser.add_argument('--url', default='http://localhost:8000', help='Backend API URL') # Corrected syntax
