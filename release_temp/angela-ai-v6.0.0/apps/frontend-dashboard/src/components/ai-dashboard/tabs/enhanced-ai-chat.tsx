                    ...
                    >
                      ...
                      <div className="max-w-[85%]">
                        ...
                        >
                          ...
                          {message.metadata && (
                            <div className="mt-2 pt-2 border-t border-border/50 text-xs font-mono text-muted-foreground">
                              <div className="flex flex-wrap gap-2">
                                {message.metadata.v_total !== undefined && (
                                  <span className={message.metadata.v_total > 0.6 ? "text-red-500 font-bold" : "text-green-500"}>
                                    [V_Total: {message.metadata.v_total?.toFixed(2)}]
                                  </span>
                                )}
                                {message.metadata.governance_lock && (
                                  <span className="text-red-500 font-bold">[M6 LOCK ENGAGED]</span>
                                )}
                                {message.metadata.tool_usage && (
                                  <span className="text-blue-500 font-bold">
                                    [Tool: {message.metadata.tool_usage}]
                                  </span>
                                )}
                              </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between mt-2 px-1">
                          ...
                          {message.type === 'assistant' && (
                            <div className="flex gap-1">
                              ...
                              >
                                <ThumbsUp
                                  className={`h-3 w-3 ${message.rating === 'positive' ? 'text-green-500' : ''
                                    }`}
                                />
                              </Button>
                              <Button
                              ...
                              >
                                <ThumbsDown
                                  className={`h-3 w-3 ${message.rating === 'negative' ? 'text-red-500' : ''
                                    }`}
                                />
                              </Button>
                              <Button
