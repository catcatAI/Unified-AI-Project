...
class MockHSPPeer,
    ...
    subject_ext_uri_reg == f"http,//example.com/ontology#Item/mock_item_{counter}"
                predicate_ext_uri_reg == "http,//purl.org/dc/elements/1.1/creator" # Mapped to cai_propcreator in ontology_mappings
...
async def main_async_runner():
    ...
    # Ensure MQTT broker is running at localhost1883
...
if __name"__main__":::
    # To run this
    # 1. Ensure MQTT broker is running (e.g., `docker run -it -p 18831883 -p 90019001 eclipse-mosquitto`)
